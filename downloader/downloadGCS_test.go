...
func testFiles(fileName string, localFile string) error {
	...
	if err != nil {
		log.Println("Failed to create aecontext") 
	...
	if err != nil {
		log.Println("Failed unzipping local file") 
