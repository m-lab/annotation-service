...
func TestSelectArchivedDataset(t *testing.T) {
	...
	filename, err := manager.SelectArchivedDataset(date1)
	...
	filename2, err := manager.SelectArchivedDataset(date2)
	...
	filename3, err := manager.SelectArchivedDataset(date3)
	...
	filename4, err := manager.SelectArchivedDataset(date4)
	...
	filename5, err := manager.SelectArchivedDataset(date5)
	...
	filename6, err := manager.SelectArchivedDataset(date6)
