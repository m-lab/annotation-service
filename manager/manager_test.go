...
func TestInitDataset(t *testing.T) {
	...
	tests := []struct {
		...
		{"1.22.128.0", "1544400000",
			`{"Geo":{"continent_code":"AS","country_code":"IN","country_name":"India","Subdivision1ISOCode":"HR","Subdivision1Name":"Haryana","city":"Faridabad","latitude":28.4333,"longitude":77.3167},"Network":{"Systems":[{"ASNs":[45528]}]}}`},
		{"2002:dced:117c::dced:117c", "1559227976",
			`{"Geo":{"continent_code":"OC","country_code":"AU","country_name":"Australia","Subdivision1ISOCode":"VIC","Subdivision1Name":"Victoria","city":"East Malvern","postal_code":"3145","latitude":-37.8833,"longitude":145.05},"Network":{"Systems":[{"ASNs":[4804]}]}}`},
	}
