...
func TestAnnotate(t *testing.T) {
	tests := []struct {
		...
		{"1.4.128.0", "625600", `{"Geo":{"Subdivision1ISOCode":"ME","city":"Not A Real City","postal_code":"10583","latitude":42.1,"longitude":-73.1},"Network":null}`},
	...
	ann := &geolite2v2.GeoDataset{
		...
		LocationNodes: []geolite2v2.LocationNode{
			{
				CityName: "Not A Real City", Subdivision1ISOCode: "ME",
			},
		},
	}
...
func TestBatchAnnotate(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			res: `{"127.0.0.1ov94o0":{"Geo":{"Subdivision1ISOCode":"ME","city":"Not A Real City","postal_code":"10583"},"Network":null},"2620:0:1003:1008:5179:57e3:3c75:1886ov97hp":{"Geo":{"Subdivision1ISOCode":"ME","city":"Not A Real City","postal_code":"10583"},"Network":null}}`,
		},
	}
