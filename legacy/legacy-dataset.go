...
func (gi *Datasets) GetAnnotation(request *api.RequestData) (api.GeoData, error) {
	if gi.v4Data == nil || gi.v6Data == nil {
		return api.GeoData{}, errors.New("Invalid dataset")
	}
	...
	return api.GeoData{}, errors.New("No record in dataset")
}
