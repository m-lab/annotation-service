...
func TestSelectGeoLegacyFile(t *testing.T) {
	...
	err := legacy.UpdateFilenamelist(testBucket)
	if err != nil {
	...
	filename, err := legacy.SelectGeoLegacyFile(date1, testBucket, true)
	...
	filename2, err := legacy.SelectGeoLegacyFile(date2, testBucket, true)
	...
	filename3, err := legacy.SelectGeoLegacyFile(date3, testBucket, true)
	...
	filename4, err := legacy.SelectGeoLegacyFile(date4, testBucket, true)
	...
	filename5, err := legacy.SelectGeoLegacyFile(date5, testBucket, true)
	...
	filename6, err := legacy.SelectGeoLegacyFile(date6, testBucket, false)
